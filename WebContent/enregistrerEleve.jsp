...
<head>
    ...
    <title>Ajout élève | Gestion établissement</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Ajout Elève</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Informations de l'élève</a></li>
                            </ul>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 centered" >
                                            <div class="review-content-section">
                                                <div id="dropzone1" class="pro-ad">
                                                    <form action="EnregistrerEleveServlet" method="post" class="needsclick add-professors" id="demo1-upload">
                                                        <div class="row centered">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input name="adresse" type="text" class="form-control" placeholder="Entrez l'adresse de l'élève">
                                                                </div>
                                                                <div class="form-group">
                                                                	<label for="age">Age: </label>
                                                                    <input name="age" type="number" class="form-control" placeholder="Entrez l'age de l'élève">
                                                                </div>
                                                                <div class="form-group">
                                                                	<label for="niveau">Niveau: </label>
                                                                    <input name="niveau" type="text" class="form-control" placeholder="Entrez le niveau d'étude de l'élève">
                                                                </div>
                                                                <div class="form-group">
