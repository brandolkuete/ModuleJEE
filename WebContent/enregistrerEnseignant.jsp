...
<head>
    ...
    <title>Ajout Enseignant | Gestion d'établissement</title>
            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            <a class="has-arrow" href="listeEnseignants.jsp" aria-expanded="false"><span class="educate-icon educate-professor icon-wrap"></span> <span class="mini-click-non">Enseignants</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="All Professors" href="listeEnseignants.jsp"><span class="mini-sub-pro">Liste des Enseignants</span></a></li>
                                <li><a title="Add Professor" href="enregistrerEnseignant.jsp"><span class="mini-sub-pro">Enregistrer un Enseignant</span></a></li>
                            </ul>
                        </li>
                        <li>
                            <a class="has-arrow" href="listeEleves.jsp" aria-expanded="false"><span class="educate-icon educate-student icon-wrap"></span> <span class="mini-click-non">Elèves</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="All Students" href="listeEleves.jsp"><span class="mini-sub-pro">Liste des Elèves</span></a></li>
                                    ...
                                    <div class="col-lg-6 col-md-7 col-sm-6 col-xs-12">
                                        <div class="header-top-menu tabl-d-n">
                                            <ul class="nav navbar-nav mai-top-nav">
                                                ...
                                                <li class="nav-item"><a href="listeEnseignants.jsp" class="nav-link">Enseignants</a>
                                                </li>
                                                <li class="nav-item"><a href="listeEleves.jsp" class="nav-link">Elèves</a>
                                                </li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Ajout Enseignant</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Informations basiques de l'enseignant</a></li>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <div id="dropzone1" class="pro-ad">
                                                    <form action="EnregistrerEnseignantServlet" class="needsclick add-professors" id="demo1-upload">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group">
                                                                    <label for="matricule">Matricule:</label>
                                                                    <input name="matricule" type="text" class="form-control" placeholder="Entrez le matricule">
                                                                </div>
                                                                <div class="form-group">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    Masculin   <input type="radio" name="sexe"> Féminin   <input type="radio" name="sexe">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="data_nais">Date de Naissance</label>
                                                                    <input name="data_nais" id="finish" type="text" class="form-control" placeholder="Date de Naissance">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="nationalite">Nationalité: </label>
                                                                    <input name="nationalite" type="text" class="form-control" placeholder="Entrez la Nationalité">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="adresse">Adresse</label>
                                                                    <input name="adresse" type="text" class="form-control" placeholder="Entrez l'adresse de l'enseignant">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="age">Age: </label>
                                                                    <input name="age" type="number" class="form-control" placeholder="Entrez l'age de l'enseignant">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="status">Status matrimonial: </label>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input name="grade" type="text" class="form-control" placeholder="Entrez le grade">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="email">Email: </label>
                                                                    <input name="email" type="email" class="form-control" placeholder="Entrez l'email">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="telephone">Téléphone: </label>
                                                                    <input name="telephone" type="text" class="form-control" placeholder="Entrez le Téléphone">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="salaire">Salaire: </label>
                                                                    <input name="salaire" type="number" class="form-control" placeholder="Entrez le salaire">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
