	...
	4- Avoir créeé la base de données "bd_systeme_scolaire" (Vous avez les parametres et les données de la base de données dans le fichier 'BD_SystemeScolaire.sql' contenu dans le dossier "Livrable ModuleJEE")

		
								LES ETAPES POUR VOIR LA DOCUMENTATION DE L'APPLICATION
								
		> Ouvrir le dossier "Livrable ModuleJEE"
