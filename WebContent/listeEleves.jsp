...
<%@page import="com.objis.cameroun.Systeme_Scolaire.domaine.Eleve"%>
...
<head>
    ...
    <title>Liste Elèves | Gestion établissement</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Liste des élèves</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
        ...
        <div class="contacts-area mg-b-15">
            <div class="container-fluid">
				...
				int j=0;
					...
					List<Eleve> listElev = (List<Eleve>) request.getAttribute("listeEleve"); 
		         	//System.out.print(listElev);
					
					//affichage de la liste des eleves bootstrap
					for(Eleve elev: listElev){
						j++;
						nbreEleves++;
						...
						out.println(
		                        ...
		                        "<div class=\"student-inner-std res-mg-b-30\">"+
		                            "<div class=\"student-img\">"+
		                                "<img class=\"img-circle\" src=\"img/student/1.jpg\" alt=\"\" />"+
		                            "</div>"+
		                            "<div class=\"student-dtl\">"+
		                                "<h2>"+elev.getNom()+" "+elev.getPrenom()+"</h2>"+
		                                "<p class=\"dp\">"+elev.getFiliere()+"</p>"+
		                                "<p class=\"dp-ag\">"+"<b>"+elev.getAge()+"</b>"+ " ans</p>"+
		                            "</div>"+
		                        "</div>"+
		                    "</div>"
								);
						if ((nbreEleves == 4)||(j == listElev.size())){
							out.println("</div>");
							nbreEleves = 0;
						}
