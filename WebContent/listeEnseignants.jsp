<%@page import="com.objis.cameroun.Systeme_Scolaire.domaine.Enseignant"%>
...
<head>
    ...
    <title>Liste Enseignants | Gestion établissement</title>
        ...
        <div class="contacts-area mg-b-15">
            <div class="container-fluid">
	            ...
	            <%
		            ...
		            int nbreEnseignants=0;
					int j=0;
					
					// recuperation de la liste des agriculteurs enregistrés dans l'objet request 
					List<Enseignant> listeEnseignant= (List<Enseignant>) request.getAttribute("listeEnseigants");
					
					//affichage de la liste des enseignants bootstrap
					for(Enseignant enseig: listeEnseignant){
						j++;
						nbreEnseignants++;
						
						if(nbreEnseignants==1){
							out.println("<div class=\"row\">");
						}
						
						out.println("<div class=\"col-lg-3 col-md-6 col-sm-6 col-xs-12\">"+
				                        "<div class=\"hpanel hblue contact-panel contact-panel-cs responsive-mg-b-30\">"+
						                    "<div class=\"panel-body custom-panel-jw\">"+
						                        ...
						                        "<h3><a href=\"\">"+enseig.getNom()+" "+ enseig.getPrenom()+"</a></h3>"+
						                        "<p class=\"all-pro-ad\">"+enseig.getAddresse()+"</p>"+
						                    "</div>"+
			                			"</div>"+
	           					 	"</div>"
								);
						
						if ((nbreEnseignants == 4)||(j == listeEnseignant.size())){
							out.println("</div>");
							nbreEnseignants = 0;
						}
					}
